...
module fp_multiplier #(
  ...
  typedef enum logic [3:0] {
    ...
    STAGE1  = 4'b0001,
    STAGE2  = 4'b0010,
    STAGE2B = 4'b1001,  // TIMING: Extra pipeline stage after DSP multiply
    STAGE3A = 4'b0011,
    STAGE3B = 4'b0100,
    STAGE4A = 4'b0101,
    STAGE4B = 4'b0110,
  ...
  // =========================================================================
  // Stage 2 -> Stage 2B Pipeline Register (TIMING: break DSP critical path)
  // =========================================================================
  ...
  logic                         result_sign_s2b;
  logic signed [ExpExtBits-1:0] tentative_exp_s2b;
  logic        [  ProdBits-1:0] product_s2b;
  ...
  always_ff @(posedge i_clk) begin
    if (i_rst) begin
      ...
      rm_s2 <= 3'b0;
      // Stage 2B registers (TIMING: after DSP multiply, before LZC)
      result_sign_s2b <= 1'b0;
      tentative_exp_s2b <= '0;
      product_s2b <= '0;
      is_special_s2b <= 1'b0;
      ...
      case (state)
        ...
        STAGE2: begin
          ...
          result_sign_s2b <= result_sign_s2;
          tentative_exp_s2b <= tentative_exp_s2;
          product_s2b <= product_s2_comb;
        ...
        STAGE2B: begin
          ...
          result_sign_s3 <= result_sign_s2b;
          tentative_exp_s3 <= tentative_exp_s2b;
          product_s3 <= product_s2b;
