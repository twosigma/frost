...
module pc_controller #(
    ...
    // 2-wide dispatch: additional sequential PC / PC_reg increment for a
    // real slot-1 emission. Zero when the slot-1 scaffolding gate is
    // asserted, preserving the 1-wide baseline exactly.
    input logic [XLEN-1:0] i_slot1_pc_advance_bytes,
  ...
  always_comb begin
    ...
    else next_pc = seq_next_pc + i_slot1_pc_advance_bytes;
  end
  ...
  always_comb begin
    ...
    else next_pc_reg = seq_next_pc_reg + i_slot1_pc_advance_bytes;
  end
