...
LONG_RUNNING_BENCHMARK_APPS = {"coremark"}
...
async def test_real_program(dut: Any) -> None:
    ...
    # Use the longer benchmark timeout for full CoreMark-style runs.
    max_cycles = (
        COREMARK_MAX_CYCLES if app_name in LONG_RUNNING_BENCHMARK_APPS else MAX_CYCLES
    )
    ...
    num_runs = 1 if app_name in LONG_RUNNING_BENCHMARK_APPS else NUM_RUNS
