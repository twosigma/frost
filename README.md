...
- **Practical performance** — 2.19 CoreMark/MHz (658 CoreMark at 300 MHz on UltraScale+) from a Tomasulo out-of-order back-end with register renaming, branch prediction (BTB + RAS), an L0 cache, and a fast two-cycle conditional-branch misprediction recovery path.
...
|----------|-----:|----------:|------:|
| CLB LUTs | 78,435 | 1,029,600 | 7.6% |
|   LUT as Logic | 66,498 | 1,029,600 | 6.5% |
|   LUT as Distributed RAM | 11,356 | — | — |
|   LUT as Shift Register | 581 | — | — |
| CLB Registers | 55,694 | 2,059,200 | 2.7% |
| Block RAM Tile | 53.5 | 2,112 | 2.5% |
| URAM | 0 | 352 | 0.0% |
| DSPs | 36 | 1,320 | 2.7% |
| CARRY8 | 4,067 | 128,700 | 3.2% |
| F7 Muxes | 6,384 | 514,800 | 1.2% |
| F8 Muxes | 2,524 | 257,400 | 1.0% |
