...
- **Practical performance** — 2.22 CoreMark/MHz (668 CoreMark at 300 MHz on UltraScale+) from a Tomasulo out-of-order back-end with register renaming, branch prediction (BTB + RAS), an L0 cache, and a fast two-cycle conditional-branch misprediction recovery path.
...
|----------|-----:|----------:|------:|
| CLB LUTs | 77,867 | 1,029,600 | 7.6% |
|   LUT as Logic | 65,907 | 1,029,600 | 6.4% |
|   LUT as Distributed RAM | 11,376 | — | — |
|   LUT as Shift Register | 584 | — | — |
| CLB Registers | 55,330 | 2,059,200 | 2.7% |
| Block RAM Tile | 53.5 | 2,112 | 2.5% |
| URAM | 0 | 352 | 0.0% |
| DSPs | 32 | 1,320 | 2.4% |
| CARRY8 | 4,047 | 128,700 | 3.1% |
| F7 Muxes | 6,388 | 514,800 | 1.2% |
| F8 Muxes | 2,523 | 257,400 | 1.0% |
