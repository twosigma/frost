...
| Resource | Used | Available | Util% |
|----------|-----:|----------:|------:|
| Slice LUTs | 139,947 | 203,800 | 68.7% |
|   LUT as Logic | 130,489 | 203,800 | 64.0% |
|   LUT as Distributed RAM | 8,382 | — | — |
|   LUT as Shift Register | 1,076 | — | — |
| Slice Registers | 93,746 | 407,600 | 23.0% |
