...
export function debugConfiguration(settings: FrostSettings, elf: string,
    id: string, resetToMain: boolean, coreXml?: string): Record<string, unknown> {
    ...
    return {
        ...
        stopAtConnect: !resetToMain, stopAtEntry: false,
        launchCompleteCommand: resetToMain ? 'exec-continue' : 'None',
        setupCommands: [
