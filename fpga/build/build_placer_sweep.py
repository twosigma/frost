...
This script runs synthesis and opt_design once, then forks into parallel place_design runs
with different placer directives. The best result (by WNS) is selected and moved to work/.
The resulting post_place.dcp can then be used by the router sweep script.
"""
...
def main() -> None:
    ...
    if winner:
        ...
        print(f"\nNext step: ./build_router_sweep.py {board_name} --skip-place")
    else:
