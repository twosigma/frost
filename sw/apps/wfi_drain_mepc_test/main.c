 ...
 * store drains. When the drain completes, take_trap can fire before the WFI
 * commits; the trap must still save the required wfi_pc+4 in mepc, not wfi_pc.
 *
 * The Makefile forces MEM_CONFIG=ddr. For each timer margin the program stores
