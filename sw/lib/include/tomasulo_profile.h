...
#define TOMASULO_PROFILE_COUNTER_COUNT 54U
...
enum tomasulo_profile_counter_idx {
    ...
    TOMASULO_PERF_HEAD_WAIT_TOTAL = 20,
    TOMASULO_PERF_HEAD_WAIT_INT = 21,
    TOMASULO_PERF_HEAD_WAIT_BRANCH = 22,
    TOMASULO_PERF_HEAD_WAIT_MUL = 23,
    TOMASULO_PERF_HEAD_WAIT_MEM_LOAD = 24,
    TOMASULO_PERF_HEAD_WAIT_MEM_STORE = 25,
    TOMASULO_PERF_HEAD_WAIT_MEM_AMO = 26,
    TOMASULO_PERF_HEAD_WAIT_FP = 27,
    TOMASULO_PERF_HEAD_WAIT_FMUL = 28,
    TOMASULO_PERF_HEAD_WAIT_FDIV = 29,
    TOMASULO_PERF_COMMIT_BLOCKED_CSR = 30,
    TOMASULO_PERF_COMMIT_BLOCKED_FENCE = 31,
    TOMASULO_PERF_COMMIT_BLOCKED_WFI = 32,
    TOMASULO_PERF_COMMIT_BLOCKED_MRET = 33,
    TOMASULO_PERF_COMMIT_BLOCKED_TRAP = 34,
    TOMASULO_PERF_INT_BACKPRESSURE = 35,
    TOMASULO_PERF_MUL_BACKPRESSURE = 36,
    TOMASULO_PERF_MEM_RESULT_BACKPRESSURE = 37,
    TOMASULO_PERF_FP_ADD_BACKPRESSURE = 38,
    TOMASULO_PERF_FMUL_BACKPRESSURE = 39,
    TOMASULO_PERF_FDIV_BACKPRESSURE = 40,
    TOMASULO_PERF_MEM_DISAMBIGUATION_WAIT = 41,
    TOMASULO_PERF_SQ_COMMITTED_PENDING = 42,
    TOMASULO_PERF_SQ_MEM_WRITE_FIRE = 43,
    TOMASULO_PERF_LQ_MEM_READ_FIRE = 44,
    TOMASULO_PERF_ROB_OCCUPANCY_SUM = 45,
    TOMASULO_PERF_LQ_OCCUPANCY_SUM = 46,
    TOMASULO_PERF_SQ_OCCUPANCY_SUM = 47,
    TOMASULO_PERF_INT_RS_OCCUPANCY_SUM = 48,
    TOMASULO_PERF_MUL_RS_OCCUPANCY_SUM = 49,
    TOMASULO_PERF_MEM_RS_OCCUPANCY_SUM = 50,
    TOMASULO_PERF_FP_RS_OCCUPANCY_SUM = 51,
    TOMASULO_PERF_FMUL_RS_OCCUPANCY_SUM = 52,
    TOMASULO_PERF_FDIV_RS_OCCUPANCY_SUM = 53,
};
