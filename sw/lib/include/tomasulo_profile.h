...
#define TOMASULO_PROFILE_COUNTER_COUNT 86U
...
enum tomasulo_profile_counter_idx {
    ...
    TOMASULO_PERF_HEAD_WAIT_TOTAL = 26,
    TOMASULO_PERF_HEAD_WAIT_INT = 27,
    TOMASULO_PERF_HEAD_WAIT_BRANCH = 28,
    TOMASULO_PERF_HEAD_WAIT_MUL = 29,
    TOMASULO_PERF_HEAD_WAIT_MEM_LOAD = 30,
    TOMASULO_PERF_HEAD_WAIT_MEM_STORE = 31,
    TOMASULO_PERF_HEAD_WAIT_MEM_AMO = 32,
    TOMASULO_PERF_HEAD_WAIT_FP = 33,
    TOMASULO_PERF_HEAD_WAIT_FMUL = 34,
    TOMASULO_PERF_HEAD_WAIT_FDIV = 35,
    TOMASULO_PERF_COMMIT_BLOCKED_CSR = 36,
    TOMASULO_PERF_COMMIT_BLOCKED_FENCE = 37,
    TOMASULO_PERF_COMMIT_BLOCKED_WFI = 38,
    TOMASULO_PERF_COMMIT_BLOCKED_MRET = 39,
    TOMASULO_PERF_COMMIT_BLOCKED_TRAP = 40,
    TOMASULO_PERF_INT_BACKPRESSURE = 41,
    TOMASULO_PERF_MUL_BACKPRESSURE = 42,
    TOMASULO_PERF_MEM_RESULT_BACKPRESSURE = 43,
    TOMASULO_PERF_FP_ADD_BACKPRESSURE = 44,
    TOMASULO_PERF_FMUL_BACKPRESSURE = 45,
    TOMASULO_PERF_FDIV_BACKPRESSURE = 46,
    TOMASULO_PERF_MEM_DISAMBIGUATION_WAIT = 47,
    TOMASULO_PERF_SQ_COMMITTED_PENDING = 48,
    TOMASULO_PERF_SQ_MEM_WRITE_FIRE = 49,
    TOMASULO_PERF_LQ_MEM_READ_FIRE = 50,
    TOMASULO_PERF_ROB_OCCUPANCY_SUM = 51,
    TOMASULO_PERF_LQ_OCCUPANCY_SUM = 52,
    TOMASULO_PERF_SQ_OCCUPANCY_SUM = 53,
    TOMASULO_PERF_INT_RS_OCCUPANCY_SUM = 54,
    TOMASULO_PERF_MUL_RS_OCCUPANCY_SUM = 55,
    TOMASULO_PERF_MEM_RS_OCCUPANCY_SUM = 56,
    TOMASULO_PERF_FP_RS_OCCUPANCY_SUM = 57,
    TOMASULO_PERF_FMUL_RS_OCCUPANCY_SUM = 58,
    TOMASULO_PERF_FDIV_RS_OCCUPANCY_SUM = 59,
    TOMASULO_PERF_LQ_L0_HIT = 60,
    TOMASULO_PERF_LQ_L0_FILL = 61,
    TOMASULO_PERF_HEAD_AND_NEXT_DONE = 62,
    TOMASULO_PERF_HEAD_WAIT_LOAD_OUTSTANDING = 63,
    TOMASULO_PERF_HEAD_WAIT_LOAD_NO_OUTSTANDING = 64,
    TOMASULO_PERF_HEAD_PLUS_ONE_DONE = 65,
    TOMASULO_PERF_COMMIT_2_OPPORTUNITY = 66,
    TOMASULO_PERF_COMMIT_2_FIRE_ACTUAL = 67,
    TOMASULO_PERF_HEAD_LOAD_ADDR_PENDING = 68,
    TOMASULO_PERF_HEAD_LOAD_SQ_DISAMBIG = 69,
    TOMASULO_PERF_HEAD_LOAD_BUS_BLOCKED = 70,
    TOMASULO_PERF_HEAD_LOAD_CDB_WAIT = 71,
    TOMASULO_PERF_HEAD_LOAD_POST_LQ = 72,
    TOMASULO_PERF_HEAD_LOAD_BB_ISSUED = 73,
    TOMASULO_PERF_HEAD_LOAD_BB_BUS_BUSY = 74,
    TOMASULO_PERF_HEAD_LOAD_BB_AMO = 75,
    TOMASULO_PERF_HEAD_LOAD_BB_SQ_WAIT = 76,
    TOMASULO_PERF_HEAD_LOAD_BB_STAGING = 77,
    TOMASULO_PERF_HEAD_INT_OPERAND_WAIT = 78,
    TOMASULO_PERF_HEAD_INT_RS_READY_NOT_ISSUED = 79,
    TOMASULO_PERF_HEAD_INT_STAGE2 = 80,
    TOMASULO_PERF_HEAD_INT_POST_RS = 81,
    TOMASULO_PERF_COMMIT_2_BLOCKED_HEAD_SERIAL = 82,
    TOMASULO_PERF_COMMIT_2_BLOCKED_NEXT_SERIAL = 83,
    TOMASULO_PERF_COMMIT_2_BLOCKED_NEXT_BRANCH_MISPRED = 84,
    TOMASULO_PERF_COMMIT_2_BLOCKED_NEXT_BRANCH_CORRECT = 85,
};
