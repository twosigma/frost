...
#define TOMASULO_PROFILE_COUNTER_COUNT 99U
...
enum tomasulo_profile_counter_idx {
    ...
    TOMASULO_PERF_HEAD_WAIT_TOTAL = 36,
    TOMASULO_PERF_HEAD_WAIT_INT = 37,
    TOMASULO_PERF_HEAD_WAIT_BRANCH = 38,
    TOMASULO_PERF_HEAD_WAIT_MUL = 39,
    TOMASULO_PERF_HEAD_WAIT_MEM_LOAD = 40,
    TOMASULO_PERF_HEAD_WAIT_MEM_STORE = 41,
    TOMASULO_PERF_HEAD_WAIT_MEM_AMO = 42,
    TOMASULO_PERF_HEAD_WAIT_FP = 43,
    TOMASULO_PERF_HEAD_WAIT_FMUL = 44,
    TOMASULO_PERF_HEAD_WAIT_FDIV = 45,
    TOMASULO_PERF_COMMIT_BLOCKED_CSR = 46,
    TOMASULO_PERF_COMMIT_BLOCKED_FENCE = 47,
    TOMASULO_PERF_COMMIT_BLOCKED_WFI = 48,
    TOMASULO_PERF_COMMIT_BLOCKED_MRET = 49,
    TOMASULO_PERF_COMMIT_BLOCKED_TRAP = 50,
    TOMASULO_PERF_INT_BACKPRESSURE = 51,
    TOMASULO_PERF_MUL_BACKPRESSURE = 52,
    TOMASULO_PERF_MEM_RESULT_BACKPRESSURE = 53,
    TOMASULO_PERF_FP_ADD_BACKPRESSURE = 54,
    TOMASULO_PERF_FMUL_BACKPRESSURE = 55,
    TOMASULO_PERF_FDIV_BACKPRESSURE = 56,
    TOMASULO_PERF_MEM_DISAMBIGUATION_WAIT = 57,
    TOMASULO_PERF_SQ_COMMITTED_PENDING = 58,
    TOMASULO_PERF_SQ_MEM_WRITE_FIRE = 59,
    TOMASULO_PERF_LQ_MEM_READ_FIRE = 60,
    TOMASULO_PERF_ROB_OCCUPANCY_SUM = 61,
    TOMASULO_PERF_LQ_OCCUPANCY_SUM = 62,
    TOMASULO_PERF_SQ_OCCUPANCY_SUM = 63,
    TOMASULO_PERF_INT_RS_OCCUPANCY_SUM = 64,
    TOMASULO_PERF_MUL_RS_OCCUPANCY_SUM = 65,
    TOMASULO_PERF_MEM_RS_OCCUPANCY_SUM = 66,
    TOMASULO_PERF_FP_RS_OCCUPANCY_SUM = 67,
    TOMASULO_PERF_FMUL_RS_OCCUPANCY_SUM = 68,
    TOMASULO_PERF_FDIV_RS_OCCUPANCY_SUM = 69,
    TOMASULO_PERF_LQ_L0_HIT = 70,
    TOMASULO_PERF_LQ_L0_FILL = 71,
    TOMASULO_PERF_HEAD_AND_NEXT_DONE = 72,
    TOMASULO_PERF_HEAD_WAIT_LOAD_OUTSTANDING = 73,
    TOMASULO_PERF_HEAD_WAIT_LOAD_NO_OUTSTANDING = 74,
    TOMASULO_PERF_HEAD_PLUS_ONE_DONE = 75,
    TOMASULO_PERF_COMMIT_2_OPPORTUNITY = 76,
    TOMASULO_PERF_COMMIT_2_FIRE_ACTUAL = 77,
    TOMASULO_PERF_HEAD_LOAD_ADDR_PENDING = 78,
    TOMASULO_PERF_HEAD_LOAD_SQ_DISAMBIG = 79,
    TOMASULO_PERF_HEAD_LOAD_BUS_BLOCKED = 80,
    TOMASULO_PERF_HEAD_LOAD_CDB_WAIT = 81,
    TOMASULO_PERF_HEAD_LOAD_POST_LQ = 82,
    TOMASULO_PERF_HEAD_LOAD_BB_ISSUED = 83,
    TOMASULO_PERF_HEAD_LOAD_BB_BUS_BUSY = 84,
    TOMASULO_PERF_HEAD_LOAD_BB_AMO = 85,
    TOMASULO_PERF_HEAD_LOAD_BB_SQ_WAIT = 86,
    TOMASULO_PERF_HEAD_LOAD_BB_STAGING = 87,
    TOMASULO_PERF_HEAD_INT_OPERAND_WAIT = 88,
    TOMASULO_PERF_HEAD_INT_RS_READY_NOT_ISSUED = 89,
    TOMASULO_PERF_HEAD_INT_STAGE2 = 90,
    TOMASULO_PERF_HEAD_INT_POST_RS = 91,
    TOMASULO_PERF_COMMIT_2_BLOCKED_HEAD_SERIAL = 92,
    TOMASULO_PERF_COMMIT_2_BLOCKED_NEXT_SERIAL = 93,
    TOMASULO_PERF_COMMIT_2_BLOCKED_NEXT_BRANCH_MISPRED = 94,
    TOMASULO_PERF_COMMIT_2_BLOCKED_NEXT_BRANCH_CORRECT = 95,
    TOMASULO_PERF_HEAD_LOAD_BB_STG_CAPTURE = 96,
    TOMASULO_PERF_HEAD_LOAD_BB_STG_LAUNCH = 97,
    TOMASULO_PERF_HEAD_LOAD_BB_STG_OTHER = 98,
};
