...
"""Split a $readmemh word image into per-bank init files for the banked
data memory (the two half-depth tdp_bram_dc_byte_en instances in
...
def main() -> int:
    ...
    parser.add_argument("--bank-output", type=Path, action="append", required=True,
